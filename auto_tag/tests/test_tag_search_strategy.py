...
@pytest.mark.parametrize("search_strategy, target_branch, expected_tag", SCENARIOS)
def test_tag_search_strategy(
    search_strategy: Callable, target_branch: str, expected_tag: str, simple_repo_two_branches: str
) -> None:
